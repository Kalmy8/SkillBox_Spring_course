...
public class BookService {
    ...
    public void removeBookByAuthor(String bookAuthorToRemove) {
        bookRepo.removeItemsByAuthor(bookAuthorToRemove);
    }
    public void removeBookBySize(String bookSizeToRemove) {
        bookRepo.removeItemsBySize(bookSizeToRemove);
    }
    public void removeBookByTitle(String bookTitleToRemove) {
        bookRepo.removeItemsByTitle(bookTitleToRemove);
    }
